<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="container flex justify-between items-center rtl:justify-end">
                ...
                <x-application-logo class="w-auto h-10 fill-current text-gray-500" />
            </div>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                ...
                                <div>{{ Auth::user()->userName }} ({{ Auth::user()->userType }})</div>
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('a-dash') }}"
                    ...
                    {{ Route::currentRouteName() == 'a-dash' ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                ...
                <ul id="patients" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('a-online') }}"
                            ...
                            {{ Route::currentRouteName() == 'a-online' ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">Manage
                            Online User</a>
                    </li>
                    <li>
                        <a href="{{ route('a-patients') }}"
                            class="text-sm flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group 
                            {{ Route::currentRouteName() == 'a-patients' ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">Manage
                            Patients</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{ route('a-queries') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Contact Queries</span>
                </a>
...
<script type="application/javascript">
    $(document).ready(function(){
        $('#p1').click(function(){
            var icon = document.getElementById('pLogo');
            if(icon.getAttribute('d') === 'm19.5 8.25-7.5 7.5-7.5-7.5'){
                icon.setAttribute('d', 'm4.5 15.75 7.5-7.5 7.5 7.5');
            }else{
                icon.setAttribute('d', 'm19.5 8.25-7.5 7.5-7.5-7.5');
            }
        })
        $('#s1').click(function(){
            var icon = document.getElementById('sLogo');
            if(icon.getAttribute('d') === 'm19.5 8.25-7.5 7.5-7.5-7.5'){
                icon.setAttribute('d', 'm4.5 15.75 7.5-7.5 7.5 7.5');
            }else{
                icon.setAttribute('d', 'm19.5 8.25-7.5 7.5-7.5-7.5');
