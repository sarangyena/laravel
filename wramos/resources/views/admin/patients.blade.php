<x-admin-layout>
    <div class="sm:ml-64 h-screen flex flex-col justify-between">
        <div class="p-4 mx-4 rounded-lg dark:border-gray-700 mt-20">
            <h1 class="text-2xl font-bold border-b-2 border-red-500 pb-1">ADMIN | VIEW PATIENTS</h1>
            <div class="pb-4 mt-3">
                                ...
                                <tr data-id="{{ $user->id }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex gap-3">
                                            ...
                                            <a
                                                href="{{ route('a-delete', ['id' => $user->id, 'route' => Route::currentRouteName()]) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="w-5 h-5">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
