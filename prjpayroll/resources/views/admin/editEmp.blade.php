            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        @endif
                        <form method="POST" action="{{route('a-update', $employee)}}" id="empForm"
                            ...
                            <div class="mt-3 columns-3">
                                ...
                                <x-select-input id="status" name="status" class="mt-1">
                                    <option selected value="{{ old('status', $employee->status) }}">
                                        {{ old('status', $employee->status) }}</option>
                            ...
                            <div class="mt-3 columns-3">
                                ...
                                <x-select-input id="job" name="job" class="mt-1" required>
                                    <option selected value="{{ old('job', $employee->job) }}">
                                        {{ old('job', $employee->job) }}</option>
                            ...
                            <div class="mt-3 columns-2">
                                ...
                                <x-text-input id="rate" class="block mt-1 w-full uppercase" type="text"
                                    name="rate" value="430" value="{{ old('rate', $employee->rate) }}"
                                    required />
                            </div>

                            <p class="font-semibold text-2xl leading-5 border-b-2 pb-2 mt-3 border-green-300">ADDRESS:
                            </p>
                            ...
                            <div class="flex mt-3 flex-row-reverse">
                                ...
                                <x-secondary-button onclick="window.location.href='{{route('a-view')}}'"
                                    class="m-3">
                                    {{ __('Cancel') }}
                                </x-secondary-button>
                            </div>
